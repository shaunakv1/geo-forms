...
class CheckinsControllerTest < ActionController::TestCase
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post :create, checkin: { address: @checkin.address, latitude: @checkin.latitude, longitude: @checkin.longitude, name: @checkin.name }
    end
  ...
  test "should update checkin" do
    patch :update, id: @checkin, checkin: { address: @checkin.address, latitude: @checkin.latitude, longitude: @checkin.longitude, name: @checkin.name }
    assert_redirected_to checkin_path(assigns(:checkin))
  end
